...
def make_noCTF_EVNODD(
    ...
    ts.grid_ctf_defocus_delta.values = torch.zeros(
...
def loop_over_tomograms(
    processing_folder: Path,
    isonet_root_dir: Path,
    binning: int,
    dim_px: Tuple[int, int, int],
):
    ...
    starfile.write(output_star, isonet_root_dir / f"isonet2_tomos_bin_{binning}.star")
